...
namespace UnityEssentials
{
    ...
    public static class SerializedDictionaryJTokenExtensions
    {
        ...
        public static void SetColor(this SerializedDictionary<string, JToken> dict, string key, UnityEngine.Color value) => dict.Set(key, value);
        ...
        public static UnityEngine.Color GetColor(this SerializedDictionary<string, JToken> dict, string key, UnityEngine.Color defaultValue) => dict.Get(key, defaultValue);
